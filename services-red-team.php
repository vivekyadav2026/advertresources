        ...
        <div class="container">
            <div class="title-area text-center mb-0">
                <div class="banner-breadcrumbs mb-15" style="font-size: 0.8rem; text-transform: uppercase; letter-spacing: 2px; color: #a9a9a9;">
                    ...
                    <span style="margin: 0 10px; opacity: 0.5;">/</span> 
                    <span style="color: #E0009B; font-weight: 600;">Red Team Assessment</span>
                </div>
                
                <span class="detail-status-tag mb-4">
                    <span class="detail-pulse-dot"></span>
                    CAPABILITY // 03 ACTIVE
                </span>
                
                <h1 class="sec-title text-white mb-3" style="font-size: clamp(2rem, 5vw, 3.2rem); font-weight: 800; background: linear-gradient(135deg, #ffffff 40%, #E0009B 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent;">Red Team Assessment</h1>
                <p class="sec-text text-white-50 mx-auto" style="max-width: 700px; font-size: 1.1rem; line-height: 1.6;">
                    Simulated advanced persistent threat (APT) attacks to comprehensively test detection and response capabilities.
                </p>
            </div>
        </div>
    </div>
            ...
            <div class="row gy-40">
                ...
                <div class="col-lg-8">
                    <div class="detail-content-card">
                        <h2 class="sec-title mb-4" style="font-size: 1.8rem; font-weight: 800;">Adversarial Emulation Operations</h2>
                        <p class="sec-text text-white-50 mb-3" style="font-size: 1.05rem; line-height: 1.75;">
                            The only way to truly validate your security posture is to subject it to real-world attack conditions. Our Red Team operations emulate the tactics, techniques, and procedures (TTPs) of sophisticated state-sponsored actors and criminal syndicates.
                        </p>
                        <p class="sec-text text-white-50 mb-5" style="font-size: 1.05rem; line-height: 1.75;">
                            Unlike standard vulnerability scans, our Red Team engagements are full-scope, objective-driven missions designed to breach your defenses, escalate privileges, and extract data, thereby exposing critical weaknesses in both technology and human processes.
                        </p>
                        ...
                        <div class="detail-check-list">
                            <ul>
                                <li class="d-flex align-items-start gap-3">
                                    ...
                                    <div>
                                        <h5 class="text-white mb-1" style="font-size: 1.05rem; font-weight: 700;">Network Penetration Testing</h5>
                                        <p class="m-0 text-white-50" style="font-size: 0.9rem; line-height: 1.5;">Identifying and exploiting vulnerabilities across internal and external network perimeters.</p>
                                    </div>
                                </li>
                                <li class="d-flex align-items-start gap-3">
                                    <div class="detail-check-icon"><i class="fas fa-user-gear"></i></div>
                                    <div>
                                        <h5 class="text-white mb-1" style="font-size: 1.05rem; font-weight: 700;">Social Engineering</h5>
                                        <p class="m-0 text-white-50" style="font-size: 0.9rem; line-height: 1.5;">Targeted spear-phishing and vishing campaigns to test employee security awareness.</p>
                                    </div>
                                </li>
                                <li class="d-flex align-items-start gap-3">
                                    <div class="detail-check-icon"><i class="fas fa-building-circle-check"></i></div>
                                    <div>
                                        <h5 class="text-white mb-1" style="font-size: 1.05rem; font-weight: 700;">Physical Security Breach Simulations</h5>
                                        <p class="m-0 text-white-50" style="font-size: 0.9rem; line-height: 1.5;">Testing on-site physical access controls, tailgating vulnerabilities, and hardware tampering.</p>
                                    </div>
                                </li>
                            </ul>
                        </div>
