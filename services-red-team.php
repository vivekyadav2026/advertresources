...
<head>
    ...
    <title>Red Team Assessment | Advert Resource Ltd</title>
...
<body>
    ...
    <main>
        <section class="page-header" style="background: var(--bg-surface);">
            <div class="container">
                <p style="font-family: var(--font-mono); color: var(--text-muted); font-size: 0.85rem; margin-bottom: 1rem;">CAPABILITY // 03</p>
                <h1 class="page-title reveal">Red Team Assessment</h1>
                <p class="page-desc reveal" style="transition-delay: 0.1s;">Simulated advanced persistent threat (APT) attacks to comprehensively test detection and response capabilities.</p>
            </div>
        </section>
            ...
            <div class="container">
                <div class="service-detail-layout reveal">
                    <div class="service-content">
                        <h2>Adversarial Emulation Operations</h2>
                        <p>The only way to truly validate your security posture is to subject it to real-world attack conditions. Our Red Team operations emulate the tactics, techniques, and procedures (TTPs) of sophisticated state-sponsored actors and criminal syndicates.</p>
                        
                        <p>Unlike standard vulnerability scans, our Red Team engagements are full-scope, objective-driven missions designed to breach your defenses, escalate privileges, and extract data, thereby exposing critical weaknesses in both technology and human processes.</p>
                        ...
                        <div class="content-box">
                            ...
                            <ul class="detail-list">
                                <li>
                                    ...
                                    <div>
                                        <strong style="color: var(--text-primary);">Network Penetration Testing</strong><br>
                                        Identifying and exploiting vulnerabilities across internal and external network perimeters.
                                    </div>
                                </li>
                                <li>
                                    <i class="fa-solid fa-check"></i>
                                    <div>
                                        <strong style="color: var(--text-primary);">Social Engineering</strong><br>
                                        Targeted spear-phishing and vishing campaigns to test employee security awareness.
                                    </div>
                                </li>
                                <li>
                                    <i class="fa-solid fa-check"></i>
                                    <div>
                                        <strong style="color: var(--text-primary);">Physical Security Breach Simulations</strong><br>
                                        Testing on-site physical access controls, tailgating vulnerabilities, and hardware tampering.
                                    </div>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div>
                        <div style="border: 1px solid var(--border-color); background: var(--bg-surface); padding: 2rem;">
                            ...
                            <p style="color: var(--text-secondary); font-size: 0.9rem; margin-bottom: 1.5rem;">Speak with an deployment architect to schedule a Red Team operation.</p>
