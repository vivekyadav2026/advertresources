        ...
        <div class="container">
            <div class="title-area text-center mb-0">
                <div class="banner-breadcrumbs mb-15" style="font-size: 0.8rem; text-transform: uppercase; letter-spacing: 2px; color: #a9a9a9;">
                    ...
                    <span style="margin: 0 10px; opacity: 0.5;">/</span> 
                    <span style="color: #E0009B; font-weight: 600;">Digital Forensics & IR</span>
                </div>
                
                <span class="detail-status-tag mb-4">
                    <span class="detail-pulse-dot"></span>
                    CAPABILITY // 05 ACTIVE
                </span>
                
                <h1 class="sec-title text-white mb-3" style="font-size: clamp(2rem, 5vw, 3.2rem); font-weight: 800; background: linear-gradient(135deg, #ffffff 40%, #E0009B 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent;">Digital Forensics & IR</h1>
                <p class="sec-text text-white-50 mx-auto" style="max-width: 700px; font-size: 1.1rem; line-height: 1.6;">
                    Rapid response to active breaches. Chain-of-custody data recovery, malware reverse engineering, and threat eviction.
                </p>
            </div>
        </div>
    </div>
            ...
            <div class="row gy-40">
                ...
                <div class="col-lg-8">
                    <div class="detail-content-card">
                        <h2 class="sec-title mb-4" style="font-size: 1.8rem; font-weight: 800;">Incident Response & Recovery</h2>
                        <p class="sec-text text-white-50 mb-3" style="font-size: 1.05rem; line-height: 1.75;">
                            When a perimeter is compromised, every second dictates the scale of the financial and reputational damage. Our Incident Response (IR) team deploys immediately to contain active breaches, halt data exfiltration, and systematically evict the threat actor from your network.
                        </p>
                        <p class="sec-text text-white-50 mb-5" style="font-size: 1.05rem; line-height: 1.75;">
                            Post-containment, our digital forensics experts perform deep chain-of-custody analysis to identify the root cause, reverse-engineer proprietary malware, and provide legally admissible evidence for regulatory bodies or litigation.
                        </p>
                        ...
                        <div class="detail-check-list">
                            <ul>
                                <li class="d-flex align-items-start gap-3">
                                    <div class="detail-check-icon"><i class="fas fa-truck-medical"></i></div>
                                    <div>
                                        <h5 class="text-white mb-1" style="font-size: 1.05rem; font-weight: 700;">Emergency Incident Response</h5>
                                        <p class="m-0 text-white-50" style="font-size: 0.9rem; line-height: 1.5;">Immediate deployment to contain ransomware, APTs, and insider threats.</p>
                                    </div>
                                </li>
                                <li class="d-flex align-items-start gap-3">
                                    <div class="detail-check-icon"><i class="fas fa-magnifying-glass-chart"></i></div>
                                    <div>
                                        <h5 class="text-white mb-1" style="font-size: 1.05rem; font-weight: 700;">Root Cause Forensics</h5>
                                        <p class="m-0 text-white-50" style="font-size: 0.9rem; line-height: 1.5;">Timeline reconstruction and memory analysis to determine exactly how the breach occurred.</p>
                                    </div>
                                </li>
                                <li class="d-flex align-items-start gap-3">
                                    <div class="detail-check-icon"><i class="fas fa-code-compare"></i></div>
                                    <div>
                                        <h5 class="text-white mb-1" style="font-size: 1.05rem; font-weight: 700;">Malware Reverse Engineering</h5>
                                        <p class="m-0 text-white-50" style="font-size: 0.9rem; line-height: 1.5;">Decompiling zero-day payloads to understand their capabilities and generate custom IOCs (Indicators of Compromise).</p>
                                    </div>
                                </li>
                            </ul>
                        </div>
