        ...
        <div class="container">
            <div class="title-area text-center mb-0">
                <div class="banner-breadcrumbs mb-15" style="font-size: 0.8rem; text-transform: uppercase; letter-spacing: 2px; color: #a9a9a9;">
                    ...
                    <span style="color: #E0009B; font-weight: 600;">Endpoint Detection & Response</span>
                </div>
                
                <span class="detail-status-tag mb-4">
                    <span class="detail-pulse-dot"></span>
                    CAPABILITY // 13 ACTIVE
                </span>
                
                <h1 class="sec-title text-white mb-3" style="font-size: clamp(2rem, 5vw, 3.2rem); font-weight: 800; background: linear-gradient(135deg, #ffffff 40%, #E0009B 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent;">Endpoint Detection and Response (EDR)</h1>
                <p class="sec-text text-white-50 mx-auto" style="max-width: 700px; font-size: 1.1rem; line-height: 1.6;">
                    Proactively detect, investigate, and respond to advanced threats targeting your endpoints. Our EDR solution.
                </p>
            </div>
        </div>
    </div>
            ...
            <div class="row gy-40">
                ...
                <div class="col-lg-8">
                    <div class="detail-content-card">
                        <h2 class="sec-title mb-4" style="font-size: 1.8rem; font-weight: 800;">Active Threat Prevention on Endpoints</h2>
                        <p class="sec-text text-white-50 mb-3" style="font-size: 1.05rem; line-height: 1.75;">
                            Endpoints remain the primary entry point for cyber threats. Advert Resource Ltd equips user devices and servers with EDR monitoring agents that analyze memory processes and registry changes continuously.
                        </p>
                        <p class="sec-text text-white-50 mb-5" style="font-size: 1.05rem; line-height: 1.75;">
                            When malicious payloads or ransomware-like activity is detected, the EDR system automatically terminates the process, isolates the endpoint from the network, and alerts our SOC teams to initiate threat containment.
                        </p>
                        ...
                        <div class="detail-check-list">
                            <ul>
                                <li class="d-flex align-items-start gap-3">
                                    <div class="detail-check-icon"><i class="fas fa-desktop"></i></div>
                                    <div>
                                        <h5 class="text-white mb-1" style="font-size: 1.05rem; font-weight: 700;">Remote Host Containment</h5>
                                        <p class="m-0 text-white-50" style="font-size: 0.9rem; line-height: 1.5;">Isolating compromised hosts from the local network via console threat actions.</p>
                                    </div>
                                </li>
                                <li class="d-flex align-items-start gap-3">
                                    <div class="detail-check-icon"><i class="fas fa-shield-halved"></i></div>
                                    <div>
                                        <h5 class="text-white mb-1" style="font-size: 1.05rem; font-weight: 700;">Behavioral Threat Hunting</h5>
                                        <p class="m-0 text-white-50" style="font-size: 0.9rem; line-height: 1.5;">Monitoring process trees, command-line syntax, and registry edits to catch fileless attacks.</p>
                                    </div>
                                </li>
                                <li class="d-flex align-items-start gap-3">
                                    <div class="detail-check-icon"><i class="fas fa-file-waveform"></i></div>
                                    <div>
                                        <h5 class="text-white mb-1" style="font-size: 1.05rem; font-weight: 700;">Forensics Logging</h5>
                                        <p class="m-0 text-white-50" style="font-size: 0.9rem; line-height: 1.5;">Ingesting active telemetry feeds and system process logs to speed up root cause analysis.</p>
                                    </div>
                                </li>
                            </ul>
                        </div>
