            ...
            <div class="row gy-40">
                ...
                <div class="col-lg-8">
                    <div class="detail-content-card">
                        <h2 class="sec-title mb-4" style="font-size: 1.8rem; font-weight: 800;">Zero-Trust Perimeter Defense</h2>
                        <p class="sec-text text-white-50 mb-3" style="font-size: 1.05rem; line-height: 1.75;">
                            The traditional castle-and-moat approach to network security is ineffective against modern intrusion methods. Advert Resource Ltd engineers zero-trust network architectures (ZTNA) where every internal transaction is verified and authenticated.
                        </p>
                        <p class="sec-text text-white-50 mb-5" style="font-size: 1.05rem; line-height: 1.75;">
                            We deploy next-generation firewalls, secure web gateways, and micro-segmentation strategies that contain breaches and prevent lateral movement through your corporate infrastructure.
                        </p>
                        ...
                        <div class="detail-check-list">
                            <ul>
                                <li class="d-flex align-items-start gap-3">
                                    ...
                                    <div>
                                        <h5 class="text-white mb-1" style="font-size: 1.05rem; font-weight: 700;">Intrusion Detection & Prevention (IDS/IPS)</h5>
                                        <p class="m-0 text-white-50" style="font-size: 0.9rem; line-height: 1.5;">Heuristic traffic analysis to drop malicious packets before they reach internal servers.</p>
                                    </div>
                                </li>
                                <li class="d-flex align-items-start gap-3">
                                    <div class="detail-check-icon"><i class="fas fa-network-wired"></i></div>
                                    <div>
                                        <h5 class="text-white mb-1" style="font-size: 1.05rem; font-weight: 700;">Micro-Segmentation</h5>
                                        <p class="m-0 text-white-50" style="font-size: 0.9rem; line-height: 1.5;">Dividing the network into isolated zones to restrict access and limit breach blast-radius.</p>
                                    </div>
                                </li>
                                <li class="d-flex align-items-start gap-3">
                                    <div class="detail-check-icon"><i class="fas fa-lock"></i></div>
                                    <div>
                                        <h5 class="text-white mb-1" style="font-size: 1.05rem; font-weight: 700;">VPN & Access Control</h5>
                                        <p class="m-0 text-white-50" style="font-size: 0.9rem; line-height: 1.5;">Encrypted tunneling and rigorous identity verification for remote workforce operations.</p>
                                    </div>
                                </li>
                            </ul>
                        </div>
