...
<head>
    ...
    <title>Capabilities Architecture | Advert Resource Ltd</title>
...
<body>
    ...
    <main>
        <section class="page-header" style="background: var(--bg-surface);">
            <div class="container">
                <h1 class="page-title reveal">Capabilities Architecture</h1>
                <p class="page-desc reveal" style="transition-delay: 0.1s;">Comprehensive security layers designed for high-risk digital environments. We deploy proactive, intelligence-driven defense systems.</p>
            </div>
        </section>

        <section class="section">
            <div class="container">
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(400px, 1fr)); gap: 0; border: 1px solid var(--border-color);" class="reveal">
                    
                    <!-- Capability 1 -->
                    <div style="padding: 3rem; border-bottom: 1px solid var(--border-color); border-right: 1px solid var(--border-color); background: var(--bg-base);">
                    ...
                    <!-- Capability 2 -->
                    <div style="padding: 3rem; border-bottom: 1px solid var(--border-color); background: var(--bg-surface);">
                    ...
                    <!-- Capability 3 -->
                    <div style="padding: 3rem; border-bottom: 1px solid var(--border-color); border-right: 1px solid var(--border-color); background: var(--bg-surface);">
                    ...
                    <!-- Capability 4 -->
                    <div style="padding: 3rem; border-bottom: 1px solid var(--border-color); background: var(--bg-base);">
                    ...
                    <!-- Capability 5 -->
                    <div style="padding: 3rem; border-right: 1px solid var(--border-color); background: var(--bg-base);">
                    ...
                    <!-- Capability 6 -->
                    <div style="padding: 3rem; background: var(--bg-surface);">
